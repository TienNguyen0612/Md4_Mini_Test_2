...
public class ProductController {
    ...
    @GetMapping
    public ResponseEntity<Iterable<Product>> findAllStudents(@RequestParam Optional<String> search) {
    ...
    @PostMapping
    public ResponseEntity<Product> saveStudent(@RequestBody Product product) {
